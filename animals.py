...
class AnimalSpider(scrapy.Spider):
    ...
    custom_settings = {
        ...
        "LOG_LEVEL": "INFO",
        "CONCURRENT_REQUESTS": 500,  # Increase concurrency
        "DOWNLOAD_DELAY": 0.25,  # Add a small delay to prevent bans
        "RANDOMIZE_DOWNLOAD_DELAY": True,  # Randomize delays for stealth
    }
